...
@override
int get hashCode => Object.hash(runtimeType,id,title,url,upvoteUrl,hasBeenUpvoted,urlHost,score,hnuser,age,commentCount,htmlText,hmac);

@override
String toString() {
  return 'PostHeader(id: $id, title: $title, url: $url, upvoteUrl: $upvoteUrl, hasBeenUpvoted: $hasBeenUpvoted, urlHost: $urlHost, score: $score, hnuser: $hnuser, age: $age, commentCount: $commentCount, htmlText: $htmlText, hmac: $hmac)';
}
...
/// Create a copy of PostHeader
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? url = null,Object? upvoteUrl = freezed,Object? hasBeenUpvoted = null,Object? urlHost = freezed,Object? score = freezed,Object? hnuser = freezed,Object? age = null,Object? commentCount = freezed,Object? htmlText = freezed,Object? hmac = freezed,}) {
