...
void main() {
  group(FeedItemCommentCountButtonPlaceholder, () {
    Widget buildSubject() => FeedItemCommentCountButtonPlaceholder();
    ...
    testWidgets('renders $AppFeedItemCommentCountButton', (tester) async {
      await tester.pumpApp(buildSubject());
      expect(
