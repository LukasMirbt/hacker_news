...
class ThreadFeedItemUserAndAge extends StatelessWidget {
  const ThreadFeedItemUserAndAge({super.key});

  @override
  Widget build(BuildContext context) {
    final age = context.select(
      (AppThreadFeedItemData data) => data.age,
    );

    final user = context.select(
      (AppThreadFeedItemData data) => data.user,
    );
