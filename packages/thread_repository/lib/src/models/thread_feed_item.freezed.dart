...
mixin _$ThreadFeedItem {
 ...
 String get id; Hnuser get hnuser; DateTime get age; String get htmlText; int get indent; int? get score; bool? get hasBeenUpvoted; String? get upvoteUrl; String? get parentUrl; String? get contextUrl; String? get onUrl; String? get replyUrl;
...
@override
int get hashCode => Object.hash(runtimeType,id,hnuser,age,htmlText,indent,score,hasBeenUpvoted,upvoteUrl,parentUrl,contextUrl,onUrl,replyUrl);

@override
String toString() {
  return 'ThreadFeedItem(id: $id, hnuser: $hnuser, age: $age, htmlText: $htmlText, indent: $indent, score: $score, hasBeenUpvoted: $hasBeenUpvoted, upvoteUrl: $upvoteUrl, parentUrl: $parentUrl, contextUrl: $contextUrl, onUrl: $onUrl, replyUrl: $replyUrl)';
}
...
@useResult
$Res call({
 String id, Hnuser hnuser, DateTime age, String htmlText, int indent, int? score, bool? hasBeenUpvoted, String? upvoteUrl, String? parentUrl, String? contextUrl, String? onUrl, String? replyUrl
});
