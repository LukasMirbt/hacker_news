...
/// Adds pattern-matching-related methods to [CurrentUserReplyParent].
extension CurrentUserReplyParentPatterns on CurrentUserReplyParent {
...
/// Adds pattern-matching-related methods to [OtherUserReplyParent].
extension OtherUserReplyParentPatterns on OtherUserReplyParent {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
