...
void main() {
  ...
  group(ContentSettingsView, () {
    ...
    testWidgets('renders $ContentSettingsBody', (tester) async {
      await tester.pumpApp(buildSubject());
      expect(find.byType(ContentSettingsBody), findsOneWidget);
    });
  });
}
