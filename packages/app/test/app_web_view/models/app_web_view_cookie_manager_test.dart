...
class _MockAppWebViewCookieAdapter extends Mock
    implements AppWebViewCookieAdapter {}

void main() {
  group(AppWebViewCookieManager, () {
    late CookieManager cookieManager;
    late AppWebViewCookieAdapter adapter;

    setUp(() {
      cookieManager = _MockCookieManager();
      adapter = _MockAppWebViewCookieAdapter();
      registerFallbackValue(
        io.Cookie('name', 'value'),
      );
    });

    AppWebViewCookieManager createSubject() {
      return AppWebViewCookieManager(
