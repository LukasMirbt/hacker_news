...
void main() {
  group(AppWebViewReloadButton, () {
    ...
    testWidgets('adds $AppWebViewReloadPressed when $IconButton '
        'is pressed', (tester) async {
      await tester.pumpApp(buildSubject());
      await tester.tap(find.byType(IconButton));
      verify(() => bloc.add(AppWebViewReloadPressed())).called(1);
    });
  });
}
