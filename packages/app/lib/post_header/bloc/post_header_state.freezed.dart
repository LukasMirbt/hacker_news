...
/// Adds pattern-matching-related methods to [PostHeaderState].
extension PostHeaderStatePatterns on PostHeaderState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PostHeaderState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PostHeaderState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PostHeaderState value)  $default,){
final _that = this;
switch (_that) {
case _PostHeaderState():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PostHeaderState value)?  $default,){
final _that = this;
switch (_that) {
case _PostHeaderState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  PostHeaderModel header,  Set<String> visitedPosts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostHeaderState() when $default != null:
return $default(_that.id,_that.header,_that.visitedPosts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  PostHeaderModel header,  Set<String> visitedPosts)  $default,) {final _that = this;
switch (_that) {
case _PostHeaderState():
return $default(_that.id,_that.header,_that.visitedPosts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  PostHeaderModel header,  Set<String> visitedPosts)?  $default,) {final _that = this;
switch (_that) {
case _PostHeaderState() when $default != null:
return $default(_that.id,_that.header,_that.visitedPosts);case _:
  return null;
