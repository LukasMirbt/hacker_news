...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String from,  LoginFormModel form)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String from,  LoginFormModel form)  $default,) {final _that = this;
switch (_that) {
case _LoginState():
return $default(_that.from,_that.form);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String from,  LoginFormModel form)?  $default,) {final _that = this;
switch (_that) {
case _LoginState() when $default != null:
return $default(_that.from,_that.form);case _:
  return null;
