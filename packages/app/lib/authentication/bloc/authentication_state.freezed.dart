...
mixin _$AuthenticationState {
 ...
 User get user; LoginRedirect get loginRedirect; WebRedirect get webRedirect; AuthenticationStatus get status;
...
@override
int get hashCode => Object.hash(runtimeType,user,loginRedirect,webRedirect,status);

@override
String toString() {
  return 'AuthenticationState(user: $user, loginRedirect: $loginRedirect, webRedirect: $webRedirect, status: $status)';
}
...
@useResult
$Res call({
 User user, LoginRedirect loginRedirect, WebRedirect webRedirect, AuthenticationStatus status
});
...
/// Create a copy of AuthenticationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? user = null,Object? loginRedirect = null,Object? webRedirect = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( User user,  LoginRedirect loginRedirect,  WebRedirect webRedirect,  AuthenticationStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthenticationState() when $default != null:
return $default(_that.user,_that.loginRedirect,_that.webRedirect,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( User user,  LoginRedirect loginRedirect,  WebRedirect webRedirect,  AuthenticationStatus status)  $default,) {final _that = this;
switch (_that) {
case _AuthenticationState():
return $default(_that.user,_that.loginRedirect,_that.webRedirect,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( User user,  LoginRedirect loginRedirect,  WebRedirect webRedirect,  AuthenticationStatus status)?  $default,) {final _that = this;
switch (_that) {
case _AuthenticationState() when $default != null:
return $default(_that.user,_that.loginRedirect,_that.webRedirect,_that.status);case _:
  return null;
...
class _AuthenticationState implements AuthenticationState {
  const _AuthenticationState({required this.user, required this.loginRedirect, required this.webRedirect, required this.status});
...
/// Create a copy of AuthenticationState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? user = null,Object? loginRedirect = null,Object? webRedirect = null,Object? status = null,}) {
