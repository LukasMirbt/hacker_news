...
mixin _$WebRedirectState {
 ...
 WebRedirectModel get redirect; OnNavigationRequest? get onNavigationRequest; InitialLoadStatus get initialLoadStatus; bool get canGoBack; bool get canGoForward; int get progress;
...
@override
int get hashCode => Object.hash(runtimeType,redirect,onNavigationRequest,initialLoadStatus,canGoBack,canGoForward,progress);

@override
String toString() {
  return 'WebRedirectState(redirect: $redirect, onNavigationRequest: $onNavigationRequest, initialLoadStatus: $initialLoadStatus, canGoBack: $canGoBack, canGoForward: $canGoForward, progress: $progress)';
}
...
@useResult
$Res call({
 WebRedirectModel redirect, OnNavigationRequest? onNavigationRequest, InitialLoadStatus initialLoadStatus, bool canGoBack, bool canGoForward, int progress
});
...
/// Create a copy of WebRedirectState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? redirect = null,Object? onNavigationRequest = freezed,Object? initialLoadStatus = null,Object? canGoBack = null,Object? canGoForward = null,Object? progress = null,}) {
  return _then(_self.copyWith(
redirect: null == redirect ? _self.redirect : redirect // ignore: cast_nullable_to_non_nullable
as WebRedirectModel,onNavigationRequest: freezed == onNavigationRequest ? _self.onNavigationRequest : onNavigationRequest // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( WebRedirectModel redirect,  OnNavigationRequest? onNavigationRequest,  InitialLoadStatus initialLoadStatus,  bool canGoBack,  bool canGoForward,  int progress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WebRedirectState() when $default != null:
return $default(_that.redirect,_that.onNavigationRequest,_that.initialLoadStatus,_that.canGoBack,_that.canGoForward,_that.progress);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( WebRedirectModel redirect,  OnNavigationRequest? onNavigationRequest,  InitialLoadStatus initialLoadStatus,  bool canGoBack,  bool canGoForward,  int progress)  $default,) {final _that = this;
switch (_that) {
case _WebRedirectState():
return $default(_that.redirect,_that.onNavigationRequest,_that.initialLoadStatus,_that.canGoBack,_that.canGoForward,_that.progress);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( WebRedirectModel redirect,  OnNavigationRequest? onNavigationRequest,  InitialLoadStatus initialLoadStatus,  bool canGoBack,  bool canGoForward,  int progress)?  $default,) {final _that = this;
switch (_that) {
case _WebRedirectState() when $default != null:
return $default(_that.redirect,_that.onNavigationRequest,_that.initialLoadStatus,_that.canGoBack,_that.canGoForward,_that.progress);case _:
  return null;
...
class _WebRedirectState extends WebRedirectState {
  const _WebRedirectState({required this.redirect, this.onNavigationRequest, this.initialLoadStatus = InitialLoadStatus.loading, this.canGoBack = false, this.canGoForward = false, this.progress = 0}): super._();
...
/// Create a copy of WebRedirectState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? redirect = null,Object? onNavigationRequest = freezed,Object? initialLoadStatus = null,Object? canGoBack = null,Object? canGoForward = null,Object? progress = null,}) {
