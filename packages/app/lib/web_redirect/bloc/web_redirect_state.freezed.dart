...
mixin _$WebRedirectState {
 ...
 WebRedirectModel get redirect; InitialLoadStatus get initialLoadStatus; WebRedirectProgressModel get progress; bool get canGoBack; bool get canGoForward; OnNavigationRequest? get onNavigationRequest;
...
@override
int get hashCode => Object.hash(runtimeType,redirect,initialLoadStatus,progress,canGoBack,canGoForward,onNavigationRequest);

@override
String toString() {
  return 'WebRedirectState(redirect: $redirect, initialLoadStatus: $initialLoadStatus, progress: $progress, canGoBack: $canGoBack, canGoForward: $canGoForward, onNavigationRequest: $onNavigationRequest)';
}
...
@useResult
$Res call({
 WebRedirectModel redirect, InitialLoadStatus initialLoadStatus, WebRedirectProgressModel progress, bool canGoBack, bool canGoForward, OnNavigationRequest? onNavigationRequest
});
...
/// Create a copy of WebRedirectState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? redirect = null,Object? initialLoadStatus = null,Object? progress = null,Object? canGoBack = null,Object? canGoForward = null,Object? onNavigationRequest = freezed,}) {
...
as bool,onNavigationRequest: freezed == onNavigationRequest ? _self.onNavigationRequest : onNavigationRequest // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( WebRedirectModel redirect,  InitialLoadStatus initialLoadStatus,  WebRedirectProgressModel progress,  bool canGoBack,  bool canGoForward,  OnNavigationRequest? onNavigationRequest)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WebRedirectState() when $default != null:
return $default(_that.redirect,_that.initialLoadStatus,_that.progress,_that.canGoBack,_that.canGoForward,_that.onNavigationRequest);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( WebRedirectModel redirect,  InitialLoadStatus initialLoadStatus,  WebRedirectProgressModel progress,  bool canGoBack,  bool canGoForward,  OnNavigationRequest? onNavigationRequest)  $default,) {final _that = this;
switch (_that) {
case _WebRedirectState():
return $default(_that.redirect,_that.initialLoadStatus,_that.progress,_that.canGoBack,_that.canGoForward,_that.onNavigationRequest);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( WebRedirectModel redirect,  InitialLoadStatus initialLoadStatus,  WebRedirectProgressModel progress,  bool canGoBack,  bool canGoForward,  OnNavigationRequest? onNavigationRequest)?  $default,) {final _that = this;
switch (_that) {
case _WebRedirectState() when $default != null:
return $default(_that.redirect,_that.initialLoadStatus,_that.progress,_that.canGoBack,_that.canGoForward,_that.onNavigationRequest);case _:
  return null;
...
class _WebRedirectState implements WebRedirectState {
  const _WebRedirectState({required this.redirect, this.initialLoadStatus = InitialLoadStatus.loading, this.progress = const WebRedirectProgressModel(), this.canGoBack = false, this.canGoForward = false, this.onNavigationRequest});
...
/// Create a copy of WebRedirectState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? redirect = null,Object? initialLoadStatus = null,Object? progress = null,Object? canGoBack = null,Object? canGoForward = null,Object? onNavigationRequest = freezed,}) {
