...
/// Adds pattern-matching-related methods to [FeedItemOptionsState].
extension FeedItemOptionsStatePatterns on FeedItemOptionsState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FeedItemOptionsState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FeedItemOptionsState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FeedItemOptionsState value)  $default,){
final _that = this;
switch (_that) {
case _FeedItemOptionsState():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FeedItemOptionsState value)?  $default,){
final _that = this;
switch (_that) {
case _FeedItemOptionsState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( FeedItemModel item)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedItemOptionsState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( FeedItemModel item)  $default,) {final _that = this;
switch (_that) {
case _FeedItemOptionsState():
return $default(_that.item);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( FeedItemModel item)?  $default,) {final _that = this;
switch (_that) {
case _FeedItemOptionsState() when $default != null:
return $default(_that.item);case _:
  return null;
