...
mixin _$CommentDraft {
 ...
 DateTime get createdAt; String get draft; String get postId; String get postUserId; String get postTitle;
...
@override
int get hashCode => Object.hash(runtimeType,createdAt,draft,postId,postUserId,postTitle);

@override
String toString() {
  return 'CommentDraft(createdAt: $createdAt, draft: $draft, postId: $postId, postUserId: $postUserId, postTitle: $postTitle)';
}
...
@useResult
$Res call({
 DateTime createdAt, String draft, String postId, String postUserId, String postTitle
});
...
/// Create a copy of CommentDraft
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? draft = null,Object? postId = null,Object? postUserId = null,Object? postTitle = null,}) {
...
mixin _$ReplyDraft {
 ...
 DateTime get createdAt; String get draft; String get parentId; String get url; String get parentUserId; String get parentHtmlText;
...
@override
int get hashCode => Object.hash(runtimeType,createdAt,draft,parentId,url,parentUserId,parentHtmlText);

@override
String toString() {
  return 'ReplyDraft(createdAt: $createdAt, draft: $draft, parentId: $parentId, url: $url, parentUserId: $parentUserId, parentHtmlText: $parentHtmlText)';
}
...
@useResult
$Res call({
 DateTime createdAt, String draft, String parentId, String url, String parentUserId, String parentHtmlText
});
...
/// Create a copy of ReplyDraft
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? draft = null,Object? parentId = null,Object? url = null,Object? parentUserId = null,Object? parentHtmlText = null,}) {
