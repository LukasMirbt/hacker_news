...
/// Adds pattern-matching-related methods to [ReplyOptionsState].
extension ReplyOptionsStatePatterns on ReplyOptionsState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ReplyOptionsState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ReplyOptionsState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ReplyOptionsState value)  $default,){
final _that = this;
switch (_that) {
case _ReplyOptionsState():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ReplyOptionsState value)?  $default,){
final _that = this;
switch (_that) {
case _ReplyOptionsState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ReplyParentModel parent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReplyOptionsState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ReplyParentModel parent)  $default,) {final _that = this;
switch (_that) {
case _ReplyOptionsState():
return $default(_that.parent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ReplyParentModel parent)?  $default,) {final _that = this;
switch (_that) {
case _ReplyOptionsState() when $default != null:
return $default(_that.parent);case _:
  return null;
