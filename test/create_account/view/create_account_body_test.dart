...
void main() {
  group(CreateAccountBody, () {
    ...
    testWidgets('renders $CreateAccountForm', (tester) async {
      await tester.pumpApp(buildSubject());
      expect(find.byType(CreateAccountForm), findsOneWidget);
    });

    testWidgets('renders $CreateAccountFooter', (tester) async {
      await tester.pumpApp(buildSubject());
      expect(find.byType(CreateAccountFooter), findsOneWidget);
    });
  });
}
