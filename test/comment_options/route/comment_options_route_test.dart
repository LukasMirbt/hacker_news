...
void main() {
  ...
  group(CommentOptionsRoute, () {
    ...
    CommentOptionsRoute createSubject() {
      return CommentOptionsRoute(
        postId: 'postId',
        commentId: commentId,
      );
    }
    ...
    group('config', () {
      test('has correct type', () {
        expect(
          ...
          isA<TypedGoRoute<CommentOptionsRoute>>(),
        );
      });

      test('has correct path', () {
        expect(
          CommentOptionsRoute.config.path,
          ':commentId/options',
        );
      });
    });
    ...
    group('buildPage', () {
      ...
      testWidgets('renders $CommentOptionsSheet '
          'with correct commentId', (tester) async {
        await tester.pumpPost(buildSubject());
        final widget = tester.widget<CommentOptionsSheet>(
